...
public class StudentController {
    ...
    public ResponseEntity<Student> getStudent(@RequestParam("admnNo") int admnNo){
    ...
    public ResponseEntity<String> updateStudent(@RequestParam("id") int id,@RequestParam("age") int age){
